...
RAPIDAPI_KEY = "REDACTED_RAPIDAPI_KEY"  # Replace this with your RapidAPI key
...
def create_dashboard():
    ...
    def update_isi_breakdown(n_clicks, crypto_input, stock_input, start_date, end_date, threshold):
        ...
        try:
            ...
            weights = calculate_investment_surety(sentiment, technical_scores, ml_score, sharpe_ratio)
