...
def execute_trading_pipeline(crypto_tickers, stock_tickers, start_date, end_date):
    ...
    try:
        ...
        return {
            ...
            "crypto_returns": crypto_returns,  # Add crypto returns
            "stock_returns": stock_returns,   # Add stock returns
        }
    except Exception as e:
...
def create_dashboard():
    ...
    app.layout = dbc.Container(
        [
                            ...
                            [
                                ...
                                dbc.CardBody(
                                    [
                                        ...
                                        dbc.Button(
                                            "Run Analysis",
                                            id="run-button",  # Correct ID
                                            color="warning",  # Gold button
                                            className="w-100",
                            ...
                            [
                                ...
                                dbc.CardBody(
                                    html.P(
                                        ...
                                        id="optimized-weights",  # Correct ID
            ...
            # Add Crypto and Stock Performance Graphs to the Layout
                    dbc.Row(
                        [
                            dbc.Col(
                                dbc.Card(
                                    [
                                        ...
                                        dbc.CardBody(
                                            dcc.Graph(id="crypto-performance-trend"),  # Crypto trendline graph
                                        ),
                                    ],
                                    style={"backgroundColor": "#2a2a2a", "border": "1px solid #FFD700"},
                                ),
                            ...
                            dbc.Col(
                                dbc.Card(
                                    [
                                        ...
                                        dbc.CardBody(
                                            dcc.Graph(id="stock-performance-trend"),  # Stock trendline graph
                                        ),
                                    ],
                                    style={"backgroundColor": "#2a2a2a", "border": "1px solid #FFD700"},
                                ),
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody(
                                dcc.Graph(id="portfolio-performance"),  # Correct ID
                            ),
                        ],
                        style={"backgroundColor": "#2a2a2a", "border": "1px solid #FFD700"},
                    ),
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody(
                                dcc.Graph(id="strategy-comparison"),  # Correct ID
                            ),
                        ],
                        style={"backgroundColor": "#2a2a2a", "border": "1px solid #FFD700"},
                    ),
                    ...
                    dbc.Collapse(
                        dbc.Card(
                            [
                                ...
                                dbc.CardBody(
                                    html.Pre(
                                        id="developer-metrics",  # Correct ID
                                        style={
                                            "color": "#FFFFFF",
    ...
    def update_dashboard(n_clicks, crypto_input, stock_input):
        ...
        # Extract cumulative returns for crypto and stocks
        crypto_data = results["crypto_returns"]
        stock_data = results["stock_returns"]

        # Crypto Performance Trendline
        crypto_fig = {
            "data": [
                go.Scatter(
                    x=crypto_data.index,
                    y=(1 + crypto_data.sum(axis=1)).cumprod(),  # Cumulative portfolio value
                    mode="lines",
        ...
        # Stock Performance Trendline
        stock_fig = {
            "data": [
                go.Scatter(
                    x=stock_data.index,
                    y=(1 + stock_data.sum(axis=1)).cumprod(),  # Cumulative portfolio value
                    mode="lines",
        ...
        return crypto_fig, stock_fig, {}, strategy_fig, f"Optimized Weights: {results['Optimized Weights']}", developer_metrics
    return app
